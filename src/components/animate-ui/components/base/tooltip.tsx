  ...
  return (
    <TooltipPortalPrimitive>
      ...
      >
        ...
        >
          {children}
          <TooltipArrowPrimitive className="z-50 size-2.5 rotate-45 rounded-[2px] bg-primary fill-primary data-[side='bottom']:-top-1 data-[side='inline-start']:-right-1 data-[side='left']:-right-1 data-[side='inline-end']:-left-1 data-[side='right']:-left-1" />
        </TooltipPopupPrimitive>
      </TooltipPositionerPrimitive>
    </TooltipPortalPrimitive>
  );
